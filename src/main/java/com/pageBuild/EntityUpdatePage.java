...
public class EntityUpdatePage {
	...
	public void getService(String tableName, CachedRowSet resultSetColumn, String primaryKey) throws SQLException {
        ...
        Helper.outputToFile(Helper.getFilePath(properties.getPageRoot(),properties.getPagePackageName())+"/"+entityObj,"update"+entity+".jsp", sb.toString());
    }
